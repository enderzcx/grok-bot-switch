...
class UiApiEditTests(IsolatedHomeTest):
    ...
    def test_static_ui_reuses_add_dialog_for_edit(self) -> None:
        ...
        self.assertIn("id=\"secret-wrap\"", html)
        self.assertIn("id=\"add-note\"", html)
        self.assertIn('id="field-max-tokens"', html)
        self.assertIn('id="field-effort"', html)
        ...
        self.assertIn("openEdit", js)
        self.assertIn("show(els.secretWrap, false)", js)
        self.assertIn("editSnapshot.parameters", js)
        self.assertIn("editSnapshot.enabled", js)
        self.assertIn("fieldId.readOnly = true", js)
...
class StaticContractTests(unittest.TestCase):
    def test_web_files_hide_secret_and_preserve_unexposed_fields(self) -> None:
        ...
        self.assertIn('id="secret-wrap"', html)
        self.assertIn('id="add-note"', html)
        self.assertIn("编辑提供方", js)
        self.assertIn("/api/providers/\" + encodeURIComponent(editSnapshot.id) + \"/update", js)
        self.assertIn("profile.parameters = Object.assign({}, editSnapshot.parameters)", js)
        self.assertIn("profile.enabled = editSnapshot.enabled", js)
        self.assertIn("els.fieldSecret.value = \"\"", js)
        self.assertIn("show(els.secretWrap, false)", js)
